...
item entity @s[scores={shop_armor=3..}] armor.chest replace golden_chestplate{display:{Name:'{"text":"金胸甲","italic":false,"color":"gray"}'}}
item entity @s armor.legs replace air
item entity @s[scores={shop_armor=2}] armor.legs replace golden_leggings{display:{Name:'{"text":"金护腿","italic":false,"color":"gray"}'}}
item entity @s armor.feet replace air
item entity @s[scores={shop_armor=1}] armor.feet replace golden_boots{display:{Name:'{"text":"金靴子","italic":false,"color":"gray"}'}}
