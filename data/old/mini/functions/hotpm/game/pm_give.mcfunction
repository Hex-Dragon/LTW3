...
execute as @a[team=!debug] run scoreboard players operation @s temp = @s mini_heart
execute as @a[team=!debug] run scoreboard players operation @s temp *= #const_100 mem
execute as @a[team=!debug] run scoreboard players operation @s temp += @s total_score_disp
