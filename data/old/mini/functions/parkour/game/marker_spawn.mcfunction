...
# 显示as
item entity @e[type=armor_stand,tag=tempo_red,tag=parkour_tempo] armor.head replace red_stained_glass
item entity @e[type=armor_stand,tag=tempo_blue,tag=parkour_tempo] armor.head replace blue_stained_glass