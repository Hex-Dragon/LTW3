...
replaceitem entity @s hotbar.8 gray_dye{lobby_item:1b,lobby_watch:1b,display:{Name:'{"text":"旁观 (按 Q 切换)","color":"white","bold":true,"italic":false}',Lore:['{"text":"你将在下一局旁观游戏","color":"gray","italic":false}']}}
