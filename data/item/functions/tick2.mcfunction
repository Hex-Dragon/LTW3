...
# 检测玩家格子锁定
execute if score $state mem matches 1.. unless score $state mem matches 6 unless score $survival mem matches 1.. as @a[team=!debugging] run function item:disable_slot/check_slot
