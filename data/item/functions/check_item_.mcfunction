...
execute positioned 8 12 2009 align xyz as @e[tag=!ltw_item_old,type=minecraft:item,nbt={"Item":{"tag":{"ltw_item":1b}}},dx=0,dy=0,dz=0,limit=1] run function item:check_item__
