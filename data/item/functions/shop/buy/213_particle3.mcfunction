...
scoreboard players add @s shop_particle_3 0
tag @s remove canbuy
tag @s[scores={shop_particle_system=1..,shop_particle_3=0,green=3..}] add canbuy
...
tellraw @s[scores={shop_particle_system=1..,shop_particle_3=1..}] ["",{"text":">> ","color":"green","bold":true},"尾迹特效已切换为 ",{"text":"水滴","color":"green"}]
execute as @s[scores={shop_particle_system=1..,shop_particle_3=1..}] at @s run function lib:sounds/hit

tellraw @s[scores={shop_particle_system=1..,shop_particle_3=0,green=..2}] ["",{"text":">> ","color":"red","bold":true},{"text":"你没有足够的绿宝石来购买它!","color":"red"}]
execute as @s[scores={shop_particle_system=1..,shop_particle_3=0,green=..2}] at @s run function lib:sounds/error
