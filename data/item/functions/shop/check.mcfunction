...
execute if score @s buy_trigger matches 7 run function item:shop/buy_arrow1
execute if score @s buy_trigger matches 8 run function item:shop/buy_arrow2
execute if score @s buy_trigger matches 9 run function item:shop/buy_arrow3
execute if score @s buy_trigger matches 10 run function item:shop/buy_orange
execute if score @s buy_trigger matches 11 run function item:shop/buy_weapon1
execute if score @s buy_trigger matches 12 run function item:shop/buy_weapon2
execute if score @s buy_trigger matches 13 run function item:shop/buy_weapon3
execute if score @s buy_trigger matches 14 run function item:shop/buy_weapon4
execute if score @s buy_trigger matches 15 run function item:shop/buy_bow
