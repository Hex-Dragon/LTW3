execute if score @s buy_trigger matches 1..21 at @s unless entity @s[x=-3,z=-63,y=7,dx=20,dy=8,dz=30] run function item:shop/error
execute if score @s buy_trigger matches 100..108 at @s unless entity @s[x=-3,z=-63,y=7,dx=20,dy=8,dz=30] run function item:shop/error
