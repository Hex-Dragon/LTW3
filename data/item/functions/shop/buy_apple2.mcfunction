# 附魔生命果 (1 gb)
    ...
    tag @s remove canbuy
    tag @s[scores={shop_apple=..0,gold=81..}] add canbuy

    tellraw @s[scores={shop_apple=2..}] ["",{"text":">> ","color":"aqua","bold":true},{"text":"你已经购买了这个物品了!","color":"aqua"}]
    tellraw @s[scores={shop_apple=1,gold=..80}] ["",{"text":">> ","color":"red","bold":true},{"text":"你没有足够的金块来购买这个物品!","color":"red"}]
    tellraw @s[scores={shop_apple=..0}] ["",{"text":">> ","color":"red","bold":true},{"text":"你需要先购买上一级的物品!","color":"red"}]
