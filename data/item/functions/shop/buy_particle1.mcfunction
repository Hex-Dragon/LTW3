...
tellraw @s[scores={shop_particle_1=1..},tag=!show_particle_1] ["",{"text":">> ","color":"aqua","bold":true},{"text":"成功切换 ","color":"aqua"},{"text":"绿光粒子","color":"green"}]
tellraw @s[scores={shop_particle_1=1..},tag=show_particle_1] ["",{"text":">> ","color":"aqua","bold":true},{"text":"你已经激活了 ","color":"aqua"},{"text":"绿光粒子","color":"green"}]
tellraw @s[scores={shop_particle_1=0,green=..-1},tag=particle] ["",{"text":">> ","color":"red","bold":true},{"text":"你没有足够的绿宝石来购买这个粒子!","color":"red"}]
