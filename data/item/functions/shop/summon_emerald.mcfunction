# 给予绿宝石
summon item ~ ~ ~ {Item:{id:"emerald",Count:1b,tag:{stats_item:1b}},Tags:["score_item","new_stats"],PickupDelay:0}
...
execute if score @s temp matches 1.. run function item:shop/summon_emerald
