...
tag @s remove canbuy
tag @s[scores={shop_apple=..0,gold=324..}] add canbuy

tellraw @s[scores={shop_apple=1..}] ["",{"text":">> ","color":"aqua","bold":true},{"text":"你已经购买了这个物品了!","color":"aqua"}]
tellraw @s[scores={shop_apple=..0,gold=..323}] ["",{"text":">> ","color":"red","bold":true},{"text":"你没有足够的金块来购买这个物品!","color":"red"}]
...
scoreboard players remove @s[tag=canbuy] gold 324
