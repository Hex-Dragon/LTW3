...
execute if score $round mem matches ..2 run function item:bonus_item/gameparty/normal/purple
execute if score $round mem matches 3 run function item:bonus_item/gameparty/score/purple
execute if score $round mem matches 4 run function item:bonus_item/gameparty/normal/purple
