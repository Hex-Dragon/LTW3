...
execute if score $round mem matches ..5 run loot spawn ~ ~ ~ loot item:gameparty/normal/green
execute if score $round mem matches 6 run loot spawn ~ ~ ~ loot item:gameparty/last/green
