...
execute if score $round mem matches ..2 run function item:bonus_item/gameparty/normal/green
execute if score $round mem matches 3 run function item:bonus_item/gameparty/score/green
execute if score $round mem matches 4 run function item:bonus_item/gameparty/normal/green
