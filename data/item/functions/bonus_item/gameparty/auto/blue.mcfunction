...
execute if score $round mem matches ..4 run loot spawn ~ ~ ~ loot item:gameparty/normal/blue
execute if score $round mem matches 5 run loot spawn ~ ~ ~ loot item:gameparty/last/blue
