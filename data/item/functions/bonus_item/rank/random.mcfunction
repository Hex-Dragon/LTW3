...
# 根据品质生成不同的物品
execute if score $t_quality mem matches ..34 run function item:bonus_item/rank/white
execute if score $t_quality mem matches 35..64 run function item:bonus_item/rank/green
