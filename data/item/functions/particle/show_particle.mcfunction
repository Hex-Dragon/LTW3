...
execute as @e[type=!player,tag=show_particle_4] at @s run particle flame ~ ~0.1 ~0.5 0.15 0.15 0.15 0.001 1 force @a
...
execute as @e[type=!player,tag=show_particle_no] at @s run particle barrier ~ ~0.5 ~ 0 0 0 0 1 force @a
