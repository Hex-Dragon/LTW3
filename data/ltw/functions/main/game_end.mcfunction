...
execute if entity @a[tag=total_rank2] if entity @a[tag=!total_rank3] run tellraw @a [{"text":"\n----- 游戏结束 -----\n\n","color":"gold","bold":true},{"text": "第一名 - ","color":"green","bold": false},{"selector": "@a[tag=total_rank1]","color":"white","bold": false},{"text": "\n第二名 - ","color":"green","bold": false},{"selector": "@a[tag=total_rank2]","color":"white","bold": false},"\n"]
execute if entity @a[tag=!total_rank2] run tellraw @a [{"text":"\n----- 游戏结束 -----\n\n","color":"gold","bold":true},{"text": "第一名 - ","color":"green","bold": false},{"selector": "@a[tag=total_rank1]","color":"white","bold": false},"\n"]
