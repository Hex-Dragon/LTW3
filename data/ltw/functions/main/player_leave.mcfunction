...
execute if score $state mem matches 1.. if score $game_type mem matches 1 if score #count mem matches ..2 run tellraw @a {"text": "由于玩家人数不足, 游戏直接结束!","color":"red"}
...
# FIXME : [010] 物品依然很偶尔给不了 [尝试过5tick改模式]
# TODO : 摸新的大厅
