...
# 显示轮数提醒
execute unless score $state mem matches 0 run tellraw @s ["",{"text":">> ","color":"aqua","bold":true},"你目前正在旁观, 游戏目前在第 ",{"score": {"name": "$round","objective": "mem"},"color": "aqua"}, {"text":"/5","color": "aqua"}," 轮, 游戏结束后就能加入啦!"]