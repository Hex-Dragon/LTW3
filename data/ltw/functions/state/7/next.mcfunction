...
# 以玩家为对象开始执行
execute as @a[tag=selecting] run function ltw:state/7/next2
execute unless entity @a[tag=selecting] if score $game_type mem matches 1 if score $round mem matches ..5 run function ltw:state/7/continue_gameparty
