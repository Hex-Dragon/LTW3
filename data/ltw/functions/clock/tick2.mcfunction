...
execute as @a[gamemode=!spectator] if score @s effect_floating matches 11.. run effect clear @s levitation
execute as @a[gamemode=!spectator] if score @s effect_floating matches 11.. run scoreboard players set @s effect_floating 0
