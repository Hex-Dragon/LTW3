...
# 给予金锭
execute if score @s temp matches 1.. run summon item ~ ~ ~ {Item:{id:"gold_ingot",Count:1b},Tags:["score_item_ingot"],PickupDelay:0}
...
scoreboard players operation @s temp %= #count_9 mem
# 给予金粒
execute if score @s temp matches 1.. run summon item ~ ~ ~ {Item:{id:"gold_nugget",Count:1b},Tags:["score_item_nugget"],PickupDelay:0}
