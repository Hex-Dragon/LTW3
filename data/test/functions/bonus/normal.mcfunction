...
# 生成奖励
execute positioned 17.5 10.2 1967.5 run function item:bonus_item/gameparty/random
execute positioned 19.5 10.2 1962.5 run function item:bonus_item/gameparty/random
execute positioned 24.5 10.2 1960.5 run function item:bonus_item/gameparty/random
execute positioned 29.5 10.2 1962.5 run function item:bonus_item/gameparty/random
execute positioned 31.5 10.2 1967.5 run function item:bonus_item/gameparty/random
execute positioned 29.5 10.2 1972.5 run function item:bonus_item/gameparty/random
execute positioned 24.5 10.2 1974.5 run function item:bonus_item/gameparty/random
execute positioned 19.5 10.2 1972.5 run function item:bonus_item/gameparty/random
...
tellraw @a ["",{"text": ">> ","color": "aqua","bold": true}, {"text": "已生成测试用奖励物品!","color": "aqua"}]
