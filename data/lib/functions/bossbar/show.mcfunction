...
execute unless score $bossbar_color mem matches 1 run bossbar set mini:red players
execute if score $bossbar_color mem matches 2 run bossbar set mini:yellow players @a
execute unless score $bossbar_color mem matches 2 run bossbar set mini:yellow players
execute if score $bossbar_color mem matches 3 run bossbar set mini:green players @a
execute unless score $bossbar_color mem matches 3 run bossbar set mini:green players
execute if score $bossbar_color mem matches 4 run bossbar set mini:blue players @a
execute unless score $bossbar_color mem matches 4 run bossbar set mini:blue players
