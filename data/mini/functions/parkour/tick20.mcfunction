...
execute if score $parkour_block mem matches 1 run setblock 1013 9 1032 minecraft:crimson_hyphae
...
execute if score $parkour_block mem matches 0 run setblock 1013 9 1032 air destroy
