...
execute positioned 1009.50 14.50 1007.50 as @a[tag=!treasure1,tag=!watcher,tag=!debug,distance=..2] unless entity @a[tag=treasure1] run tellraw @a ["",{"text": ">> ","color":"green","bold": true},{"selector": "@s","color":"green"} , " 第一个获得了 ",{"text": "营地屋顶","color":"green"}," 的宝藏!"]
...
execute positioned 1021.50 15.50 1016.50 as @a[tag=!treasure2,tag=!watcher,tag=!debug,distance=..2] unless entity @a[tag=treasure2] run tellraw @a ["",{"text": ">> ","color":"green","bold": true},{"selector": "@s","color":"green"} , " 第一个获得了 ",{"text": "沙漠骨骸","color":"green"}," 的宝藏!"]
...
execute positioned 1008.50 30.50 1020.50 as @a[tag=!treasure3,tag=!watcher,tag=!debug,distance=..2] unless entity @a[tag=treasure3] run tellraw @a ["",{"text": ">> ","color":"green","bold": true},{"selector": "@s","color":"green"} , " 第一个获得了 ",{"text": "神庙立柱","color":"green"}," 的宝藏!"]
...
execute positioned 1011.50 19.50 1058.50 as @a[tag=!treasure4,tag=!watcher,tag=!debug,distance=..2] unless entity @a[tag=treasure4] run tellraw @a ["",{"text": ">> ","color":"green","bold": true},{"selector": "@s","color":"green"} , " 第一个获得了 ",{"text": "下界之门","color":"green"}," 的宝藏!"]
...
execute positioned 1026.50 18.50 1047.00 as @a[tag=!treasure5,tag=!watcher,tag=!debug,distance=..2] unless entity @a[tag=treasure5] run tellraw @a ["",{"text": ">> ","color":"green","bold": true},{"selector": "@s","color":"green"} , " 第一个获得了 ",{"text": "落日森林","color":"green"}," 的宝藏!"]
...
execute positioned 1004.50 18.50 1043.50 as @a[tag=!treasure6,tag=!watcher,tag=!debug,distance=..2] unless entity @a[tag=treasure6] run tellraw @a ["",{"text": ">> ","color":"green","bold": true},{"selector": "@s","color":"green"} , " 第一个获得了 ",{"text": "地狱之顶","color":"green"}," 的宝藏!"]
...
execute positioned 1013.00 08.50 1041.00 as @a[tag=!treasure7,tag=!watcher,tag=!debug,distance=..2] unless entity @a[tag=treasure7] run tellraw @a ["",{"text": ">> ","color":"green","bold": true},{"selector": "@s","color":"green"} , " 第一个获得了 ",{"text": "节奏舞厅","color":"green"}," 的宝藏!"]
...
execute positioned 1007.50 13.50 1025.50 as @a[tag=!treasure8,tag=!watcher,tag=!debug,distance=..2] unless entity @a[tag=treasure8] run tellraw @a ["",{"text": ">> ","color":"green","bold": true},{"selector": "@s","color":"green"} , " 第一个获得了 ",{"text": "末路营火","color":"green"}," 的宝藏!"]
