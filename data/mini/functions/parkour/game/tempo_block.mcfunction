...
execute if score $parkour_block mem matches 0 run setblock 1009 16 1051 air destroy
execute if score $parkour_block mem matches 0 run setblock 1004 17 1050 air destroy
