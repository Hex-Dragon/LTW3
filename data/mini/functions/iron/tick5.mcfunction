...
execute if score $countdown mem matches ..60 run effect give @a[team=playing,tag=!invisible] glowing 1000000 0 true
execute if score $countdown mem matches ..60 run effect clear @a[team=playing,tag=invisible] glowing
