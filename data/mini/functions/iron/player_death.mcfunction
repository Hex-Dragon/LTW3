...
execute if score #cobblestone_count temp matches 3.. at @e[type=armor_stand,tag=dead_marker,limit=1] run summon item ~0.1 ~0.2 ~0.1 {Tags:["temp_cobblestone"],Item:{id:"minecraft:cobblestone",Count:1b}}
