...
# 召唤猪灵
execute if score $random mem matches 1..15 if score $countdown mem matches 1.. run function mini:zombie/game/summon_empty
...
execute if score $random mem matches 1..15 if score $countdown mem matches ..0 unless entity @e[tag=empty_pig] run function mini:zombie/game/summon_equip
