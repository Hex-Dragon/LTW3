...
execute if score $mini_type mem matches 202 run function mini:rgb/game_init
execute if score $mini_type mem matches 101 run function mini:diamond/game_init
