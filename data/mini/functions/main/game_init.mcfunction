...
execute if score $mini_type mem matches -1 run function mini:diamond/game_init
execute if score $mini_type mem matches 6 run function mini:ass/game_init
execute if score $mini_type mem matches -2 run function mini:trade/game_init
