...
execute if score $mini_type mem matches 5 run function mini:zombie/game_init
execute if score $mini_type mem matches 6 run function mini:phantom/game_init
execute if score $mini_type mem matches 7 run function mini:slime/game_init
