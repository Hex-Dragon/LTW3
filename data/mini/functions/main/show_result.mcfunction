...
# 记分
# scoreboard players add @s[tag=mini_rank1,team=!watching] total_score 3
# scoreboard players add @s[tag=mini_rank1,team=!watching] total_score_disp 3
# scoreboard players add @s[tag=mini_rank2,team=!watching] total_score 2
# scoreboard players add @s[tag=mini_rank2,team=!watching] total_score_disp 2
# scoreboard players add @s[tag=mini_rank3,team=!watching] total_score 1
# scoreboard players add @s[tag=mini_rank3,team=!watching] total_score_disp 1
# scoreboard players add @s[tag=mini_rank4,team=!watching] total_score 0
# scoreboard players add @s[tag=mini_rank4,team=!watching] total_score_disp 0
