...
execute if score $mini_type mem matches -1 run function mini:diamond/player_intro
execute if score $mini_type mem matches 6 run function mini:ass/player_intro
execute if score $mini_type mem matches -2 run function mini:trade/player_intro