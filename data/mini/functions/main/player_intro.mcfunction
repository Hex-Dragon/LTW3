...
execute if score $mini_type mem matches 6 run function mini:phantom/player_intro
execute if score $mini_type mem matches 7 run function mini:slime/player_intro