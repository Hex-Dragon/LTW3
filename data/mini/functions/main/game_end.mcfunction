...
execute as @a run function mini:main/get_score_max
execute as @a unless entity @a[tag=mini_rank1] if score @s mini_score = $t_score_max mini_score run tag @s add mini_rank1
scoreboard players set $t_score_max mini_score -2147483648
execute as @a[tag=!mini_rank1] run function mini:main/get_score_max
...
scoreboard players set $t_score_max mini_score -2147483648
execute as @a[tag=!mini_rank1,tag=!mini_rank2] run function mini:main/get_score_max
