...
scoreboard players set $t_score_max mini_score -2147483648
execute as @a[tag=!mini_rank1] run scoreboard players operation $t_score_max mini_score > @s mini_score
...
scoreboard players set $t_score_max mini_score -2147483648
execute as @a[tag=!mini_rank1,tag=!mini_rank2] run scoreboard players operation $t_score_max mini_score > @s mini_score
