...
execute as @a if score @s mini_score > $t_score_max mini_score run scoreboard players operation $t_score_max mini_score = @s mini_score
execute as @a unless entity @a[tag=mini_rank1] if score @s mini_score = $t_score_max mini_score run tag @s add mini_rank1
scoreboard players set $t_score_max mini_score -2147483648
execute as @a[tag=!mini_rank1] if score @s mini_score > $t_score_max mini_score run scoreboard players operation $t_score_max mini_score = @s mini_score
...
scoreboard players set $t_score_max mini_score -2147483648
execute as @a[tag=!mini_rank1,tag=!mini_rank2] if score @s mini_score > $t_score_max mini_score run scoreboard players operation $t_score_max mini_score = @s mini_score
