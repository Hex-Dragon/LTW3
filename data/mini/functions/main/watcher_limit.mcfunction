...
execute if score $mini_type mem matches 6 run function mini:diamond/watcher_limit
execute if score $mini_type mem matches 7 run function mini:ass/watcher_limit
execute if score $mini_type mem matches 8 run function mini:trade/watcher_limit