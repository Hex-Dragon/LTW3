...
execute if score $mini_type mem matches 6 run function mini:diamond/game_start
execute if score $mini_type mem matches 7 run function mini:koth/game_start
execute if score $mini_type mem matches 8 run function mini:trade/game_start