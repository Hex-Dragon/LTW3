...
# 显示提示
execute if entity @s[tag=!rejoining] if score $player_finish mem matches ..3 run tellraw @a ["",{"text": ">> ","color":"green"},{"selector": "@s","color":"yellow"}," 已成功! 获得了第 ",{"score": {"name": "$player_finish","objective": "mem"}}," 名!"]
