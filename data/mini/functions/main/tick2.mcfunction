...
execute if score $mini_type mem matches -1 run function mini:diamond/tick2
execute if score $mini_type mem matches 6 run function mini:ass/tick2
execute if score $mini_type mem matches -2 run function mini:trade/tick2