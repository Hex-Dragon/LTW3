...
item replace entity @s hotbar.8 with minecraft:netherite_pickaxe{game_item:1b,display:{Name:'{"text":"镐","italic":false}'},Enchantments:[{id:"minecraft:efficiency",lvl:10s}]} 1