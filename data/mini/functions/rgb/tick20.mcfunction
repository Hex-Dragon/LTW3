...
execute if score $scb_switch rgb_sys matches 2..3 run scoreboard objectives setdisplay sidebar rgb_R
execute if score $scb_switch rgb_sys matches 4..5 run scoreboard objectives setdisplay sidebar rgb_R