...
execute positioned 1001 10 4000 if score $color_match_floor mem matches 3 run clone ~ ~ ~ ~20 ~ ~20 ~ ~1 ~ filtered bedrock
...
execute positioned 1001 10 4000 if score $color_match_floor mem matches 6 run clone ~ ~ ~ ~20 ~ ~20 ~ ~1 ~ filtered gold_block
