# 去除地板
fill 1049 16 3999 1071 16 4021 air replace #mini:colarmatch_floor

# 替换方块
execute positioned 1001 11 4000 run clone ~ ~ ~ ~20 ~ ~20 1050 16 4000 filtered #mini:colarmatch_floor
