...
# 设置倒计时
execute if score $color_match_time mem matches 47.. run scoreboard players remove $color_match_time mem 5
execute if score $color_match_time mem matches 18..46 run scoreboard players remove $color_match_time mem 1
