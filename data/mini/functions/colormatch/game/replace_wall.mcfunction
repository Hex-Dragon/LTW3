...
execute if score $color_match_floor mem matches 10 run fill 1075 11 3999 1075 40 4025 emerald_block
execute if score $color_match_floor mem matches 10 run fill 1075 11 3999 1049 40 3999 emerald_block
execute if score $color_match_floor mem matches 10 run fill 1049 11 3999 1049 40 4025 emerald_block
execute if score $color_match_floor mem matches 10 run fill 1049 11 4025 1075 40 4025 emerald_block
