...
execute if score $countdown_fast mem matches 1.. if score $color_match_type mem matches 1 run title @a actionbar [{"text":"下一轮: ","color":"red","bold": true},{"score": { "name": "$countdown_fast","objective": "mem"}}]