...
execute as @a[team=playing,gamemode=survival] if entity @s[tag=noVillager] if score @s interactVillager matches 1.. run scoreboard players reset @s interactVillager
