...
# execute if score @s temp matches 3 run loot spawn ~ ~ ~ loot mini:trade_s
# execute if score @s temp matches 4 run loot spawn ~ ~ ~ loot mini:trade_s
# execute if score @s temp matches 5 run loot spawn ~ ~ ~ loot mini:trade_s
