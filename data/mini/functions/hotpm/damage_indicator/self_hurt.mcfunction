...
# 进行伤害提示
tellraw @a[tag=damage_taken,scores={damage_taken=0..}] [{"text":"[!] ","color":"red"},{"text":"你受到了","color":"white"},{"color":"red","score":{"name":"@a[tag=damage_taken,scores={damage_taken=0..}]","objective":"damage_counter1"}},{"text":".","color":"red"},{"color":"red","score":{"name":"@a[tag=damage_taken,scores={damage_taken=0..}]","objective":"damage_counter2"}},{"text":"点伤害","color":"white"}]
