...
execute if score $mini_type mem matches 6 run scoreboard objectives setdisplay belowName total_score
execute if score $mini_type mem matches 6 run scoreboard objectives setdisplay sidebar slime_score
