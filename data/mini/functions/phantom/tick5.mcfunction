...
# 给予进度
execute as @a[tag=!watcher,scores={temp=1..,kill_phantom=10}] run advancement grant @s only ltw:combat/phantom_1
execute as @a[tag=!watcher,scores={temp=1..,kill_phantom=20}] run advancement grant @s only ltw:combat/phantom_2
execute as @a[tag=!watcher,scores={temp=1..,kill_phantom=30}] run advancement grant @s only ltw:combat/phantom_3