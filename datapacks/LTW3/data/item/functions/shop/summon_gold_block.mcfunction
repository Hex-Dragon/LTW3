# 给予金块
summon item ~ ~ ~ {Item:{id:"gold_block",Count:1b,tag:{stats_item:1b}},Tags:["score_item","new_stats"],PickupDelay:0}
...
execute if score @s temp matches 1.. run function item:shop/summon_gold_block
